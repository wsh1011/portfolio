        ...
        $(document).ready(function() {
            ...
            $(".find").click(function() {       // 아이디찾기 버튼을 클릭, id입력 상자에 id값 입력시
                ...
                $.ajax({    // ajax 로 data를 넘겨줌
                    type: "POST",
                    url: "./find.php",            //접근할 php파일 
                    data: "name="+ name+ "&hp1="+hp1+ "&hp2="+hp2+ "&hp3="+hp3, // data는 파라미터 넘기는거, 변수 여러개 넘길때 &씀, 매개변수id도 같이 넘겨줌
                    cache: false,
            ...
            <form name="find" method="post" action="find.php">
                <ul>
                    ...
                    <li class="hp">
                        ...
                        <input type="text" id="hp2" name="hp2" required maxlength="4" placeholder="(ex. 1111)">   <!-- maxlength="4"하면 4글자까지만 입력됨 -->
                        <span>-</span>
